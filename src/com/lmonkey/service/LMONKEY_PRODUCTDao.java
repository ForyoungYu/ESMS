...
public class LMONKEY_PRODUCTDao {
	public static int insert(LMONKEY_PRODUCT p) {
		...
		Object[] params = { p.getPRODUCT_NAME(), p.getPRODUCT_DESCRIPTION(),
				p.getPRODUCT_PRICE(), p.getPRODUCT_STOCK(), p.getPRODUCT_FID(),
				p.getPRODUCT_CID(), p.getPRODUCT_FILENAME()
		...
		try {
			...
			while (rs.next()) {
				LMONKEY_PRODUCT p = new LMONKEY_PRODUCT(
						...
						rs.getInt("PRODUCT_PRICE"), rs.getInt("PRODUCT_STOCK"),
						rs.getInt("PRODUCT_FID"), rs.getInt("PRODUCT_CID"),
	...
	public static LMONKEY_PRODUCT selectById(int id) {
		...
		try {
			...
			while (rs.next()) {
				p = new LMONKEY_PRODUCT(rs.getInt("PRODUCT_ID"),
	...
	public static ArrayList<LMONKEY_PRODUCT> selectAllById(
