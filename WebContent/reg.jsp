...
<body><!-------------------reg-------------------------->
<div class="reg">
    <form action="register" method="post" onsubmin=""><h1><a href="index.html"><img src="img/temp/logo.png"></a></h1>
        <p><h1 style="padding:0px;margin:0px;font-size:30px;background:#3344AA;text-align:center; line-Hight:60px;color:#FFFFFF">用户注册</h1></p>
        ...
        <p><input type="text" name="birthday" value="" onfocus="c.show(this)" placeholder="请确认出生日期"><span></span></p>
        <p><input type="text" name="email" value="" placeholder="请输入邮箱"><span></span></p>
        <p><input type="text" name="mobil" value="" placeholder="请输入手机号"><span></span></p>
        ...
        <img height="25" src="getcode" alt="看不清，换一张" onclick="change(this)"><span class="error"></span></p>
